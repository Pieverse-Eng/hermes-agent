...
class TestAdapterBehavior(unittest.TestCase):
    ...
    def test_download_remote_document_uses_bounded_shared_fetch(self):
        """Remote documents use the shared response boundary before caching."""
        from gateway.config import PlatformConfig
        from plugins.platforms.feishu.adapter import FeishuAdapter
        ...
        self.assertGreater(request.await_args.kwargs["max_bytes"], 0)
