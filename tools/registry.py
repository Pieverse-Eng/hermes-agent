...
class ToolEntry:
    ...
    __slots__ = (
        ...
        "max_result_size_chars", "dynamic_schema_overrides", "parallel_safe",
    )
...
class ToolRegistry:
    ...
    def is_tool_parallel_safe(self, name: str) -> bool:
        """Return whether a tool explicitly permits concurrent execution."""
        entry = self.get_entry(name)
